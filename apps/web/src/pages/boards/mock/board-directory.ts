import type { BoardDirectoryItem } from "../model/types";

export const boardDirectory = {
  notices: {
    label: "전체 공지 게시판",
...
} as const satisfies Record<string, BoardDirectoryItem>;

export type BoardKey = keyof typeof boardDirectory;
